...
public:
	...
	virtual void drawRectangleMenu(std::pair<size_t, size_t> size, std::pair<size_t, size_t> position, color_t color, color_t outline, int thickness) = 0;
	virtual void drawTextMenu(std::string text, std::pair<size_t, size_t> position, color_t color) = 0;
