...
void PacmanGame::setLayerBorders()
{
    ...
    this->_entities[4][0][1] = std::make_shared<WallEntity>("assets/pacman/walls/botleftdouble.png", 1, "", std::make_pair(0, 4));
}
...
void PacmanGame::setLayerModules()
{
    ...
    this->_entities[6][16][1] = std::make_shared<WallEntity>("assets/pacman/walls/rightverticalsimple.png", 1, "", std::make_pair(16, 6));
    this->_entities[6][17][1] = std::make_shared<WallEntity>("assets/pacman/walls/leftverticalsimple.png", 1, "", std::make_pair(17, 6));
...
{
    this->_entities[10][0][1] = std::make_shared<WallEntity>("assets/pacman/walls/bothorizontal.png", 1, "", std::make_pair(0, 10));
    this->_entities[10][1][1] = std::make_shared<WallEntity>("assets/pacman/walls/bothorizontal.png", 1, "", std::make_pair(1, 10));
    this->_entities[10][2][1] = std::make_shared<WallEntity>("assets/pacman/walls/bothorizontal.png", 1, "", std::make_pair(2, 10));
    this->_entities[10][3][1] = std::make_shared<WallEntity>("assets/pacman/walls/bothorizontal.png", 1, "", std::make_pair(3, 10));
    this->_entities[10][4][1] = std::make_shared<WallEntity>("assets/pacman/walls/bothorizontal.png", 1, "", std::make_pair(4, 10));
    this->_entities[10][5][1] = std::make_shared<WallEntity>("assets/pacman/walls/botrightdouble.png", 1, "", std::make_pair(5, 10));

    this->_entities[12][0][1] = std::make_shared<WallEntity>("assets/pacman/walls/tophorizontal.png", 1, "", std::make_pair(0, 12));
    this->_entities[12][1][1] = std::make_shared<WallEntity>("assets/pacman/walls/tophorizontal.png", 1, "", std::make_pair(1, 12));
    this->_entities[12][2][1] = std::make_shared<WallEntity>("assets/pacman/walls/tophorizontal.png", 1, "", std::make_pair(2, 12));
    this->_entities[12][3][1] = std::make_shared<WallEntity>("assets/pacman/walls/tophorizontal.png", 1, "", std::make_pair(3, 12));
    this->_entities[12][4][1] = std::make_shared<WallEntity>("assets/pacman/walls/tophorizontal.png", 1, "", std::make_pair(4, 12));
    this->_entities[12][5][1] = std::make_shared<WallEntity>("assets/pacman/walls/toprightdouble.png", 1, "", std::make_pair(5, 12));

    this->_entities[10][24][1] = std::make_shared<WallEntity>("assets/pacman/walls/bothorizontal.png", 1, "", std::make_pair(24, 10));
    this->_entities[10][23][1] = std::make_shared<WallEntity>("assets/pacman/walls/bothorizontal.png", 1, "", std::make_pair(23, 10));
    this->_entities[10][22][1] = std::make_shared<WallEntity>("assets/pacman/walls/bothorizontal.png", 1, "", std::make_pair(22, 10));
    this->_entities[10][21][1] = std::make_shared<WallEntity>("assets/pacman/walls/bothorizontal.png", 1, "", std::make_pair(21, 10));
    this->_entities[10][20][1] = std::make_shared<WallEntity>("assets/pacman/walls/bothorizontal.png", 1, "", std::make_pair(20, 10));
    this->_entities[10][19][1] = std::make_shared<WallEntity>("assets/pacman/walls/botleftdouble.png", 1, "", std::make_pair(19, 10));

    this->_entities[12][24][1] = std::make_shared<WallEntity>("assets/pacman/walls/tophorizontal.png", 1, "", std::make_pair(24, 12));
    this->_entities[12][23][1] = std::make_shared<WallEntity>("assets/pacman/walls/tophorizontal.png", 1, "", std::make_pair(23, 12));
    this->_entities[12][22][1] = std::make_shared<WallEntity>("assets/pacman/walls/tophorizontal.png", 1, "", std::make_pair(22, 12));
    this->_entities[12][21][1] = std::make_shared<WallEntity>("assets/pacman/walls/tophorizontal.png", 1, "", std::make_pair(21, 12));
    this->_entities[12][20][1] = std::make_shared<WallEntity>("assets/pacman/walls/tophorizontal.png", 1, "", std::make_pair(20, 12));
    this->_entities[12][19][1] = std::make_shared<WallEntity>("assets/pacman/walls/topleftdouble.png", 1, "", std::make_pair(19, 12));
}
