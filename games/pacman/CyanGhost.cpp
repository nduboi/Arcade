...
CyanGhost::CyanGhost(std::pair<size_t, size_t> spawnPosition, std::shared_ptr<IEntity> pacman, float multi)
{
    this->_spriteNames[0] = "assets/pacman/ghosts/inky.png";
    this->_spriteNames[1] = "assets/pacman/ghosts/inky2.png";
...
void CyanGhost::checkPacmanCollision(std::shared_ptr<IGameModule> gameModule)
{
...
void CyanGhost::moveEntity(std::shared_ptr<IGameModule> gameModule)
{
...
void CyanGhost::moveTocell(std::shared_ptr<IGameModule> gameModule, std::pair<size_t, size_t> newPos)
{
    grid_t grid = gameModule->getEntities();
...
void CyanGhost::moveToSpawn(std::shared_ptr<IGameModule> gameModule)
{
...
void CyanGhost::moveToPacman(std::shared_ptr<IGameModule> gameModule)
{
    std::pair<size_t, size_t> pacmanPos = this->_pacman->getPosition();
...
void CyanGhost::runAway(std::shared_ptr<IGameModule> gameModule)
{
    std::pair<size_t, size_t> pacmanPos = this->_pacman->getPosition();
...
std::pair<size_t, size_t> CyanGhost::findBestPathToTarget(std::shared_ptr<IGameModule> gameModule,
...
int CyanGhost::calculateManhattanDistance(const std::pair<size_t, size_t>& pos1, const std::pair<size_t, size_t>& pos2) {
