...
void OrangeGhost::checkPacmanCollision(std::shared_ptr<IGameModule> gameModule)
{
...
void OrangeGhost::moveEntity(std::shared_ptr<IGameModule> gameModule)
{
...
void OrangeGhost::moveTocell(std::shared_ptr<IGameModule> gameModule, std::pair<size_t, size_t> newPos)
{
    grid_t grid = gameModule->getEntities();
...
void OrangeGhost::moveToSpawn(std::shared_ptr<IGameModule> gameModule)
{
...
void OrangeGhost::moveToPacman(std::shared_ptr<IGameModule> gameModule)
{
    std::pair<size_t, size_t> pacmanPos = this->_pacman->getPosition();
...
void OrangeGhost::runAway(std::shared_ptr<IGameModule> gameModule)
{
    std::pair<size_t, size_t> pacmanPos = this->_pacman->getPosition();
...
std::pair<size_t, size_t> OrangeGhost::findBestPathToTarget(std::shared_ptr<IGameModule> gameModule,
...
int OrangeGhost::calculateManhattanDistance(const std::pair<size_t, size_t>& pos1, const std::pair<size_t, size_t>& pos2) {
